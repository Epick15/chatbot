        ...
        <div class="p-4 p-xl-5 flex-grow-1 d-flex align-items-center">
          <div class="w-100">
            <Link href="/" class="link-fx fw-semibold fs-2 text-white">
              Epick <span class="fw-normal">System</span>
            </Link>
            <p class="text-white-75 me-xl-8 mt-2">
              ¡Bienvenido a tu increíble aplicación! No dudes en iniciar sesión y acceder a tu panel de control.
            </p>
          </div>
        </div>
        <div
        ...
        <div class="p-4 w-100 flex-grow-1 d-flex align-items-center">
          <div class="w-100">
            ...
            <div class="text-center mb-5">
              <h1 class="fw-black mb-2">Iniciar sesión.</h1>
              <p class="fw-medium text-muted">
                Bienvenido, por favor inicie sesión o
